...
parser.add_argument('-train_data', '--train_data_dir', type=str, default='/nobackup/users/xiaotx/ffn_lm/xtx_train/2017EXBB/train_down2_pad/', help='training data')
...
parser.add_argument('--stream', type=str, default="ddl", help='job_stream')
