...
parser.add_argument('--data', type=str, default='/home/xiaotx/2017EXBB/train_data/thick_dense_sparse_coord_d/(0, 1024, 0)_raw.h5', help='input images')
parser.add_argument('--model', type=str, default=default='/home/xiaotx/2017EXBB/model/model_fov51_delta15_dep12/ffn_model_fov:51_delta:15_depth:12.pth', help='path to ffn model')
